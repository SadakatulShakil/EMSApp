...
public class AttendanceHistoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        attendanceHistoryList.setLayoutManager(new LinearLayoutManager(AttendanceHistoryActivity.this));
        attendanceAdapter = new AttendanceAdapter(AttendanceHistoryActivity.this, mAttendanceArrayList);
    ...
    private void inItView() {
        ...
        monthAdapter = new MonthAdapter(AttendanceHistoryActivity.this, monthArrayList);
        ...
        monthSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(monthName.equals("Select Month..")){
                    Toast.makeText(AttendanceHistoryActivity.this, "Please Select Your desire month first", Toast.LENGTH_SHORT).show();
                }else{
