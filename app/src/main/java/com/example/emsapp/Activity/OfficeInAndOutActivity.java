...
public class OfficeInAndOutActivity extends AppCompatActivity {
    ...
    private  String addingTimeForStart, addingTimeForFinish,
            addingDate, addressForStart, addressForFinish,addressStart, addressFinish, monthName;
    ...
    private void storeStartStatus(String addressStart, String monthName) {
        ...
        attendanceReference.setValue(attendanceInfo).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
