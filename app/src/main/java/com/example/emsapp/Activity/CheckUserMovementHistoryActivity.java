...
public class CheckUserMovementHistoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_check_user_movement_history);
        inItList();
        inItView();
        Intent intent = getIntent();
        employeeInfo = (Employee) intent.getSerializableExtra("userInfo");

        movementHistoryList.setLayoutManager(new LinearLayoutManager(CheckUserMovementHistoryActivity.this));
        movementAdapter = new MovableAdapter(CheckUserMovementHistoryActivity.this, mMovementArrayList);
    ...
    private void inItView() {
        ...
        monthAdapter = new MonthAdapter(CheckUserMovementHistoryActivity.this, monthArrayList);
        ...
        monthSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(monthName.equals("Select Month..")){
                    Toast.makeText(CheckUserMovementHistoryActivity.this, "Please Select Your desire month first", Toast.LENGTH_SHORT).show();
                }else{
