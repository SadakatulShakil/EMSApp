...
import com.example.emsapp.Activity.UserAttendanceListActivity;
import com.example.emsapp.Model.Employee;
import com.example.emsapp.R;

import java.util.ArrayList;

public class UserListForAttendanceAdapter extends RecyclerView.Adapter<UserListForAttendanceAdapter.viewHolder> {
    private Context context;
    private ArrayList<Employee> employeeArrayList;

    public UserListForAttendanceAdapter(Context context, ArrayList<Employee> employeeArrayList) {
    ...
    @NonNull
    @Override
    public UserListForAttendanceAdapter.viewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.employee_list, parent, false);
        return new UserListForAttendanceAdapter.viewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull UserListForAttendanceAdapter.viewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context, UserAttendanceListActivity.class);
